export const DISTRIBUTION_ACTIONS = {
  ATTEMPT_TO_FETCH_DISTRIBUTION:
    "dashboard/@HOSPICE/ATTEMPT_TO_FETCH_DISTRIBUTION",
  SET_FETCH_DISTRIBUTION_SUCCEED:
    "dashboard/@HOSPICE/SET_FETCH_DISTRIBUTION_SUCCEED",
  SET_FETCH_DISTRIBUTION_FAILURE:
    "dashboard/@HOSPICE/SET_FETCH_DISTRIBUTION_FAILURE",
  RESET_FETCH_DISTRIBUTION_STATE:
    "dashboard/@HOSPICE/RESET_FETCH_DISTRIBUTION_STATE",

  ATTEMPT_TO_CREATE_DISTRIBUTION:
    "dashboard/@HOSPICE/ATTEMPT_TO_CREATE_DISTRIBUTION",
  SET_CREATE_DISTRIBUTION_SUCCEED:
    "dashboard/@HOSPICE/SET_CREATE_DISTRIBUTION_SUCCEED",
  SET_CREATE_DISTRIBUTION_FAILURE:
    "dashboard/@HOSPICE/SET_CREATE_DISTRIBUTION_FAILURE",
  RESET_CREATE_DISTRIBUTION_STATE:
    "dashboard/@HOSPICE/RESET_CREATE_DISTRIBUTION_STATE",

  ATTEMPT_TO_UPDATE_DISTRIBUTION:
    "dashboard/@HOSPICE/ATTEMPT_TO_UPDATE_DISTRIBUTION",
  SET_UPDATE_DISTRIBUTION_SUCCEED:
    "dashboard/@HOSPICE/SET_UPDATE_DISTRIBUTION_SUCCEED",
  SET_UPDATE_DISTRIBUTION_FAILURE:
    "dashboard/@HOSPICE/SET_UPDATE_DISTRIBUTION_FAILURE",
  RESET_UPDATE_DISTRIBUTION_STATE:
    "dashboard/@HOSPICE/RESET_UPDATE_DISTRIBUTION_STATE",

  ATTEMPT_TO_DELETE_DISTRIBUTION:
    "dashboard/@HOSPICE/ATTEMPT_TO_DELETE_DISTRIBUTION",
  SET_DELETE_DISTRIBUTION_SUCCEED:
    "dashboard/@HOSPICE/SET_DELETE_DISTRIBUTION_SUCCEED",
  SET_DELETE_DISTRIBUTION_FAILURE:
    "dashboard/@HOSPICE/SET_DELETE_DISTRIBUTION_FAILURE",
  RESET_DELETE_DISTRIBUTION_STATE:
    "dashboard/@HOSPICE/RESET_DELETE_DISTRIBUTION_STATE",
};
//FETCH Distribution
